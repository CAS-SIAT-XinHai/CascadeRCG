...
def main(embed_path, know_db_path, pro_db_path, all_db_path, reranker_path):
    ...
    encoder_model = FlagModel(embed_path,
                              ...
                              use_fp16=True)
    return all_vectordb, know_db_path, pro_vectordb, model, encoder_model
...
if __name__ == "__main__":
    ...
    main(args.embed_path, args.know_db_path, args.pro_db_path, args.all_db_path, args.reranker_path)
